 ...
 */
@NonNullByDefault
@Component(configurationPid = "binding.bmtemperature", service = ThingHandlerFactory.class)
public class BmTemperatureHandlerFactory extends BaseThingHandlerFactory {
